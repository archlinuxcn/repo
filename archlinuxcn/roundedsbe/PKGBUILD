...
license=('GPL3')
makedepends=('cmake' 'extra-cmake-modules' 'kglobalaccel' 'kde-dev-utils' 'knotifications' 'kinit' 'kwin' 'qt5-declarative')
depends=('kcoreaddons' 'libxcb' 'kwindowsystem' 'kdecoration' 'kiconthemes')
