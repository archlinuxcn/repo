...
source=("https://archive.mozilla.org/pub/firefox/releases/100.0b5/linux-x86_64/en-US/firefox-$pkgver.tar.bz2"
        "$_pkgname.sh"
        "$pkgname.desktop")
sha256sums=('458fb3135b83ce463080aa26cead4bcd2b579d9cfcf747afbe9b0c09ae19def0'
