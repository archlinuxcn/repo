...
source=("https://archive.mozilla.org/pub/firefox/releases/98.0b2/linux-x86_64/en-US/firefox-$pkgver.tar.bz2"
        "$_pkgname.sh"
        "$pkgname.desktop")
sha256sums=('c98aa7c9f471705e47592c6df7f25d03f448db3f285498ad9595e03e207eec60'
