...
source=("https://archive.mozilla.org/pub/firefox/releases/121.0b6/linux-x86_64/en-US/firefox-$pkgver.tar.bz2"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('824383303b4cbf3f85c905e57188000c0830a285482bc41edac6727fba557438'
