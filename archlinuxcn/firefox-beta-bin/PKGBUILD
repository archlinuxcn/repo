...
source=("http://archive.mozilla.org/pub/firefox/candidates/$pkgver-candidates/build1/linux-x86_64/en-US/firefox-$pkgver.tar.bz2"
        "$_pkgname.sh"
        "$pkgname.desktop")
sha256sums=('389b11d44e6b50684e309b89bbc7baca1e86a2be26c3809b490b77fc3ccdb48a'
