...
source=("https://archive.mozilla.org/pub/firefox/candidates/120.0-candidates/build1/linux-x86_64/en-US/firefox-$pkgver.tar.bz2"
        "$_pkgname.sh"
        "$pkgname.desktop")
sha256sums=('f2146c5863b4a866a7cab86ca3660e336dfc30aa44c27fffd06a06c61bc2b4dd'
