...
source=("https://archive.mozilla.org/pub/firefox/candidates/$pkgver-candidates/build1/linux-x86_64/en-US/firefox-$pkgver.tar.bz2"
        "$_pkgname.sh"
        "$pkgname.desktop")
sha256sums=('f69dd789390ef1d8528431f8b4733ec5c278d5afe5bd1eac584baed5cb41ced9'
