...
source=("https://archive.mozilla.org/pub/firefox/candidates/92.0-candidates/build2/firefox-$pkgver.tar.bz2"
        "$_pkgname.sh"
        "$pkgname.desktop")
sha256sums=('dc1e1566cdc066c8ef55c5fe551536067151337bf287edc14c0ce33130cf3b14'
