...
source=("https://archive.mozilla.org/pub/firefox/releases/97.0b8/linux-x86_64/en-US/firefox-$pkgver.tar.bz2"
        "$_pkgname.sh"
        "$pkgname.desktop")
sha256sums=('c59171d15de7881a55429be64ff9b83a6ab727b38139fc2e3a318017ae7ea8ef'
