...
source=("https://files.pythonhosted.org/packages/source/${_name::1}/${_name}/iredis-1.15.2.tar.gz")
sha256sums=('c8f3279e09398abd1525ccf020e9f75a7152e3dae0e04769306f810a6f96fc60')

build() {
  cd "$srcdir/iredis-1.15.2"
