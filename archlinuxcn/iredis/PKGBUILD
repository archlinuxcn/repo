...
source=("https://files.pythonhosted.org/packages/source/${_name::1}/${_name}/iredis-1.16.1.tar.gz")
sha256sums=('862a67a59e05710cb6547bdff55e3b6801298578f78d39e7fa953424f68793df')

build() {
  cd "$srcdir/iredis-1.16.1"
