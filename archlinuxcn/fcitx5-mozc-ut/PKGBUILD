...
depends=('fcitx5' 'mozc>=3.33.6133' 'qt6-base')
makedepends=('git' 'mold' 'python')
optdepends=('fcitx5-configtool')
provides=('fcitx5-mozc=3.33.6133')
conflicts=('fcitx5-mozc')
source=('mozc-fcitx::git+https://github.com/fcitx/mozc.git#commit=da1065bf3b03a825cdca462b8588e387d85549e4'
...
noextract=('abseil-cpp-20250814.0.tar.gz'
           ...
           'zlib-1.3.1.tar.gz')
b2sums=('b69ab0e28df07de0a8e89df86c565354e76f0f685daa1d69f5e03b8a884a148837c182f4b3265b7585a7f833f989663616d5e3086aaf471f9da687ce48c609c4'
