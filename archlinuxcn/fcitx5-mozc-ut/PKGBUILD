...
depends=('fcitx5' 'mozc>=3.33.6239' 'qt6-base')
makedepends=('git' 'python')
optdepends=('fcitx5-configtool')
provides=('fcitx5-mozc=3.33.6239')
conflicts=('fcitx5-mozc')
source=('mozc-fcitx::git+https://github.com/fcitx/mozc.git#commit=767a4de6912092ea16098d8ce14943249e74bad1'
...
noextract=('abseil-cpp-20260107.1.tar.gz'
           ...
           'zlib-1.3.1.tar.gz')
b2sums=('f855527046777361e432bea52d49f2ddaa25b71cc7c1a33bcc383880acdead8d4a6c11058efac3c43ef1f45a51091853d56ae7f9698c95147542585929494225'
