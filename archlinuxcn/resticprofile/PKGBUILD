...
sha256sums=('4b423bd35674bd9e8f7d8e63d5f586c1e6b357c8d83dd30724036763ac4645c7')
...
package() {
    ...
    install -Dm644 contrib/completion/fish-completion.fish "${pkgdir}/usr/share/fish/vendor_completions.d/resticprofile.fish"
}
