...
prepare() {
    ...
    sed -i '1 i #include <cstdint>' src/external/RectangleBinPack/MaxRectsBinPack.cpp
    sed -i '1 i #include <cstdint>' src/external/lunasvg/source/property.h
    sed -i '1 i #include <cstdint>' src/external/lunasvg/include/lunasvg.h
    sed -i '1 i #include <cstdint>' src/emu/common/include/common/types.h
    sed -i '1 i #include <cstdint>' src/emu/common/include/common/watcher.h
    sed -i '1 i #include <cstdint>' src/emu/common/include/common/path.h
    sed -i '1 i #include <cstdint>' src/emu/utils/include/utils/uchar.h 
    sed -i '1 i #include <cstdint>' src/emu/scripting/include/scripting/server.h 
    sed -i '1 i #include <cstdint>' src/emu/scripting/include/scripting/session.h 
    sed -i '1 i #include <cstdint>' src/emu/scripting/include/scripting/thread.h 
    sed -i '1 i #include <cstdint>' src/emu/scripting/include/scripting/process.h 
    sed -i '1 i #include <cstdint>' src/emu/services/include/services/bluetooth/btmidman.h 
    sed -i '1 i #include <cstdint>' src/emu/j2me/include/j2me/applist.h 
}
