...
sha512sums=('16c075054320c6e47fa6afd3d6724f107a9ffb14d6baa7fe33e5396531b08b0f648365cfd10eff7af1336c1974546f8f6e59aa8e7fe7f3d2d9bae786d948cbf7'
...
check() {
  ...
  "target/release/${pkgname}" --version > actual.txt
  if ! grep -qF "Packetry version ${pkgver}" actual.txt
  then
