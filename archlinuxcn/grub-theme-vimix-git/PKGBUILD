...
package() {
    ...
    install -Dm 644 "config/theme-$resolution.txt" "$pkgdir/usr/share/grub/themes/$name/theme.txt"
    install -Dm 644 "backgrounds/$resolution/background-${_pkgname##*-}.jpg" "$pkgdir/usr/share/grub/themes/$name/background.jpg"
    install -Dm 644 "assets/assets-white/icons-$resolution"/* "$pkgdir/usr/share/grub/themes/$name/icons"
    install -Dm 644 "assets/assets-white/select-$resolution"/* "$pkgdir/usr/share/grub/themes/$name"
