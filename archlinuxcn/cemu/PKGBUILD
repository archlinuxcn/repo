...
depends=(
	# unbundled vcpkg
	'boost-libs>=1.79' 'fmt>=9.1' 'libzip>=1.9.2' 'libpng>=1.6.37' 'pugixml>=1.12.1' 'sdl2>=2.0.22' 'wxwidgets-gtk3>=3.2' 'wayland' 'wayland-protocols'
	'llvm-libs>=12'
)
makedepends=(
	# build setup
...
source=(
	git+https://github.com/cemu-project/Cemu#tag=v2.0-45
	# submodules
