...
license=('BSD')
depends=('python>=3.7' 'python-numpy>=1.17.0' 'erfa>=2.0.0')
...
package() {
  ...
  PYTHONHASHSEED=0 PYERFA_USE_SYSTEM_LIBERFA=1 python setup.py install --root="${pkgdir}/" --optimize=1 --skip-build
}
