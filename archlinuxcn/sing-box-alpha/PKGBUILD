...
sha256sums=('08d73c7a80c4fc9f1f23d9f90e27db4f637bd312080c4287f2d3ec60f233ead5')
...
package() {
    ...
    install -Dm644 "release/config/${_pkgname}-split-dns.xml" -t "${pkgdir}/usr/share/dbus-1/system.d/"
