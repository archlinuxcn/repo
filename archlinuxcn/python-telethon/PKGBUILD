...
source=("https://files.pythonhosted.org/packages/source/${_name::1}/${_name}/telethon-1.41.2.tar.gz")
sha256sums=('300a3441df62668378626b46cafda346573e9ac296367182510756334d2bdc5e')

build() {
  cd "$srcdir/telethon-1.41.2"
