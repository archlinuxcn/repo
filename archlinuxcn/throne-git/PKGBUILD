...
build() {
	...
	go build -v \
		-o ../build \
		-ldflags "-compressdwarf=false -linkmode=external -X 'github.com/sagernet/sing-box/constant.Version=${VERSION_SINGBOX}' -X 'internal/godebug.defaultGODEBUG=multipathtcp=0' -checklinkname=0" \
