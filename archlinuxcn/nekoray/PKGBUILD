...
source=(
	...
	"nekobox.sh"
	"nekobox.desktop"
	"https://github.com/MatsuriDayo/nekoray/pull/1350.patch"
)
sha512sums=('86a5bd9c86b12b1bee5678917bf9c3da744b02141589cc737b3ba65dc918f7abb881a899aed47be11b0a0ae09511be1bedd0a8a8819a20efe6a2874efe942bb0'
            ...
            '132b4c9b278baf494ddf6739f0188253ed3830b6fb7b232be0029f52ad7c04a6fb0210cc330330e84f82d1def7b88f7911caf7db23c28ac9f8a91a8386437f8f')

prepare() {
	cd "${pkgname}/"
	patch -p1 <../1350.patch # Add /usr/share/sing-box to core asset search path
}
