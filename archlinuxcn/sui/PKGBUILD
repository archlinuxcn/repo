...
sha512sums=('65d6da3419d441b65545775b9c9d4d35bd40179082e5d0768583d1c1364188c3e8ad7cd74aed1268a6ebafa1f9d0c62aa5334c3c8ef86f802ffeb0be3e6933e2')
...
package() {
  ...
  binarys=(sui sui-bridge sui-bridge-cli sui-data-ingestion sui-faucet sui-node sui-test-validator sui-tool)
  for binary in "${binarys[@]}"; do
