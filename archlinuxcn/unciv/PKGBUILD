...
pkgname=unciv
_pkgname=Unciv
_gradle_ver=6.7.1 # This package does not work with system gradle
pkgver=3.16.5.googlePlayPushTest
...
md5sums=('ed20654dc119b245f60ba55c3dab317c'
         'd9a00ebe42fa4e2345c0e8e3287ff8c9'
