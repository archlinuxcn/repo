...
prepare() {
	...
	git config submodule.plugins/mediaremote.url "${srcdir}/${_pkgname}-plugin-mediaremote/"
	git config submodule.plugins/menubar.url "${srcdir}/${_pkgname}-plugin-menubar/"
	git config submodule.plugins/obsidian.url "${srcdir}/${_pkgname}-plugin-obsidian/"
	...
	git config submodule.plugins/spotify.url "${srcdir}/${_pkgname}-plugin-spotify/"
