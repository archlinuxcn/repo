...
package() {
    ...
    install -Dm 644 "backgrounds/4k/background-${_pkgname##*-}.jpg" "$pkgdir/usr/share/grub/themes/$name/background.jpg"
    install -Dm 644 assets/assets-tela/icons/* "$pkgdir/usr/share/grub/themes/$name/icons"
    install -Dm 644 assets/assets-tela/select/*.png "$pkgdir/usr/share/grub/themes/$name"
