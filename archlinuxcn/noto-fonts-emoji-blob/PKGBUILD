...
source=("Blobmoji-${pkgver}.ttf::https://github.com/C1710/blobmoji/releases/download/v${pkgver}/Blobmoji.ttf")
sha256sums=('ab8e432fc80c4ffabd7cd8e58718268c5a758fdcf75e5e024ef9a2c5ad106bd8')

package() {
    mkdir -p "$pkgdir"/usr/share/fonts/blobmoji
    install -m644 Blobmoji-${pkgver}.ttf "$pkgdir"/usr/share/fonts/blobmoji/Blobmoji.ttf
}
