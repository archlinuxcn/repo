...
sha256sums=('71c532ce09992e470f3259ffeb38d2b5bba990c243a559e4726a57412bd36b54'
            'SKIP'
            'f2a1e621d8a0138c5aaf88a5bfd91580133d319fcdc2ac9192f290a78305d185'
...
if [ "${CARCH}" = "i486" -o  "${CARCH}" = "i686" -o "${CARCH}" = "pentium4" ]; then
  ...
  for ((i=0; i<${#sha256sums[@]}; i++)); do
    if [ "${sha256sums[${i}]}" = 'f2a1e621d8a0138c5aaf88a5bfd91580133d319fcdc2ac9192f290a78305d185' ]; then
      sha256sums_pentium4=('bac1aa5920045297701bab46d67c95403e48c0bc5df98532d6f43505aae8f146')
      sha256sums_i686=('d8d650922c6ca3f9c8dfe9c4734710e8a089aa85bafa6e1af23de8bf3d4b6c03')
      sha256sums_i486=('9b307b53fea4ce3e1824b5eee3497762bfd7dd38c2c8fee810e1f105063087a1')
    fi
  done
