...
pkgver=6034.52dd24968
pkgrel=1
pkgdesc="x86 emulator with builtin DOS, with patches with more features"
arch=(i686 x86_64)
url="http://dosbox.sourceforge.net"
license=(GPL)
depends=(fluidsynth sdl2 sdl2_net sdl2_mixer libxkbfile libpng libxrandr mesa ffmpeg)
makedepends=(git glu)
optdepends=()
...
build() {
  ...
  ./configure --enable-sdl2 --enable-avcodec --prefix=/usr --sysconfdir=/etc/dosbox-x
  make
}
