...
package() {
  ...
  install -m644 stop?.svg "$pkgdir/usr/share/silentcast"
  install -D -m644 silentcast.svg "$pkgdir/usr/share/pixmaps/silentcast.svg"
  ...
  install -m644 *svg "$pkgdir/usr/share/doc/silentcast"
