...
pkgbase=linux-beignet-fix       # Build kernel with a different name
_srcname=linux-4.0
pkgver=4.0.4
pkgrel=1
arch=('i686' 'x86_64')
...
sha256sums=('0f2f7d44979bc8f71c4fc5d3308c03499c26a824dd311fdf6eef4dee0d7d5991'
            ...
            '87e23817f647af755f11283a0be4b6fee8a0ca6a95c9d90f20e18ec34b93fc12')
# validpgpkeys=(
...
prepare() {
  ...
  # patch to enable local memory for using beignet
  patch -p1 -i "${srcdir}/disable-batchbuffer-security.patch"
