...
md5sums_i686=('f909f0b7bb40239080a2487c4a31cd6e')
md5sums_x86_64=('68e4be4d8d641cd55d7a9ebb9df0d1a5')

## Previous build (also see: /var/cache/pacman/pkg/google-chrome-dev-*):
#source_x86_64=('http://mirror.pcbeta.com/google/chrome/deb/pool/main/g/google-chrome-unstable/google-chrome-unstable_49.0.2587.3-1_amd64.deb')
#md5sums_x86_64=('68e4be4d8d641cd55d7a9ebb9df0d1a5')
