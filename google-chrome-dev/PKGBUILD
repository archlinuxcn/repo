...
md5sums=('892fe529136874dd8ae62d6a6e0dba39'
         'SKIP'
         '11b55a3fec7279db32b63e3a0b97dc01')

## Previous build (also see: /var/cache/pacman/pkg/google-chrome-dev-*):
#source[0]='http://mirror.glendaleacademy.org/chrome/pool/main/g/google-chrome-unstable/google-chrome-unstable_57.0.2987.19-1_amd64.deb'
#md5sums[0]='fdf51010d2291ab68e0d67908f8a4413'
