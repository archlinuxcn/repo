...
md5sums_i686=('eaed5594d4c6e89320869f298c2d6c1c')
md5sums_x86_64=('86041c90fcc12e435ef2d5a9677a5ef0')

## Previous build (also see: /var/cache/pacman/pkg/google-chrome-dev-*):
#source_x86_64=('http://mirror.pcbeta.com/google/chrome/deb/pool/main/g/google-chrome-unstable/google-chrome-unstable_48.0.2564.8_amd64.deb')
#md5sums_x86_64=('e0cdd9d3ecb0613df19a71c61b1bf01d')
