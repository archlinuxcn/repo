...
md5sums=('d0d3f6563552630f3dead0cab1ee0c76'
         'SKIP'
         '11b55a3fec7279db32b63e3a0b97dc01')

## Previous build (also see: /var/cache/pacman/pkg/google-chrome-dev-*):
#source[0]='http://mirror.glendaleacademy.org/chrome/pool/main/g/google-chrome-unstable/google-chrome-unstable_53.0.2756.0-1_amd64.deb'
#md5sums[0]='67a629601f66d0908174950938cdaff7'
