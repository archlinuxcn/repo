...
md5sums=('d03ad2f5fd9c2a5007c7d62a26c5ce2b'
         'SKIP'
         '11b55a3fec7279db32b63e3a0b97dc01')

## Previous build (also see: /var/cache/pacman/pkg/google-chrome-dev-*):
#source[0]='http://mirror.glendaleacademy.org/chrome/pool/main/g/google-chrome-unstable/google-chrome-unstable_59.0.3043.0-1_amd64.deb'
#md5sums[0]='ac644a6601f02506a0d69e9175cbb7f2'
